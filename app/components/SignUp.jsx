...
import { AuthAppleIcon, AuthfacebookIcon, AuthGoogleIcon, EmailIcon, HidePasswordIcon, LockIcon, ProfileBarIcon } from '../../assets/icons'
    ...
    return (
        <View style={styles.container}>
            ...
            <View>
                ...
                <Text style={styles.subtitle}>Please enter your details to Signup!</Text>
                <View style={styles.inputcontainer}>
                    <ProfileBarIcon style={styles.inputicon} />
                    <TextInput style={styles.input} placeholder="Enter your Name" placeholderTextColor="#C3C3C3" />
                </View>
                <View style={styles.inputcontainer}>
                ...
                <Pressable style={styles.loginbutton} onPress={() => {setLogin(true)}}><Text style={styles.loginbuttontext}>Signup</Text></Pressable>
            ...
            <View style={styles.signupcontainer}>
                ...
                <Pressable style={styles.signupbutton} onPress={() => setLogin(true)}><Text style={styles.signupbuttontext}> Login</Text></Pressable>
            </View>
        </View>
    )
}
