...
const CurrentPlanScreen = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.subtitle}>Lorem ipsum dolor amet, consectetur adipiscing elit.</Text>
            <View style={styles.featurecontainer}>
                <View style={[styles.discounttag, { display: 'flex' }]}>
                    <Text style={styles.discounttagtext}>Monthly</Text>
                </View>
                <View style={styles.featuretitle}>
                    <Text style={styles.featuretitletext}>FitAura Premium</Text>
                    <Text style={styles.featurepackagetext}>$4.99<Text style={styles.featurepackagetext1}>/Monthly</Text></Text>
                </View>
            ...
            <QuestionnaireButton title={'Upgrade Plan'} onPress={() => navigation.navigate('UpgradePlanScreen')}/>
        </View>
    )
}
